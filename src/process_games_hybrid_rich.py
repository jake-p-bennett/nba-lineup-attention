"""
Process game data for hybrid model with RICH stats (7 features).

Uses: off_rating, def_rating, net_rating, pts_per100, reb_per100, possessions, games_played

This provides more diverse features for the attention model to learn from.
"""
...
def load_data():
    """Load play-by-play data and RICH player stats."""
    print("Loading data...")

    # Load RICH player stats (7 features)
    ...
    print(f"Features per player: {len(stat_cols)}")
...
def main():
    ...
    # Save to RICH directory
    output_dir = DATA_DIR / 'games_hybrid_rich_processed'
    ...
    print(f"\n{'='*50}")
    print("SUMMARY (RICH STATS - 7 features)")
    print(f"{'='*50}")
